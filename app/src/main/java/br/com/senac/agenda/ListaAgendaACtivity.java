...
public class ListaAgendaACtivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listaagenda);

        AgendaDAO dao = new AgendaDAO(this);
        final List<Agenda> agenda = dao.listaagenda();
        ...
        listaagenda.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intentlk = new Intent(ListaAgendaACtivity.this, FormularioAgendaActivity.class);
        ...
        novoagenda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentlinkFormulario = new Intent(ListaAgendaACtivity.this,FormularioAgendaActivity.class );
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, final ContextMenu.ContextMenuInfo menuInfo) {
        ...
        deletar.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                Toast.makeText(ListaAgendaACtivity.this, "Deletar " + agenda.getId(), Toast.LENGTH_LONG).show();

                AgendaDAO dao = new AgendaDAO(ListaAgendaACtivity.this);
                dao.deleta(agenda);
                dao.close();
